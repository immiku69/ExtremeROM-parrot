...
[ ! -f "$WORK_DIR/system/system/priv-app/SAppLock/SAppLock.apk" ] && \
    ADD_TO_WORK_DIR "pa3qzcx" "system" "system/priv-app/AppLock" 0 0 755 "u:object_r:system_file:s0"
ADD_TO_WORK_DIR "pa3qzcx" "system" "system/priv-app/SmartManagerCN" 0 0 755 "u:object_r:system_file:s0"
ADD_TO_WORK_DIR "pa3qzcx" "system" "system/priv-app/SmartManager_v6_DeviceSecurity_CN" 0 0 755 "u:object_r:system_file:s0"
