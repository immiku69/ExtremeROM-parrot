...
DELETE_FROM_WORK_DIR "$WORK_DIR/system/system/priv-app/KnoxGuard"
DELETE_FROM_WORK_DIR "$WORK_DIR/system/system/etc/permissions/privapp-permissions-com.samsung.android.kgclient.xml"
